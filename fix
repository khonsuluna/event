...
mini.MouseButton1Click:Connect(function()
    if not minimized then
        ...
        -- simpan posisi dan ukuran lama
        originalSize = frame.Size
        originalPos  = frame.Position
        
        -- semua child disembunyikan kecuali tombol mini
        ...
        -- ubah tampilan tombol mini jadi ikon besar
        mini.Text = "⬤"
        mini.Font = Enum.Font.GothamBold
        mini.TextSize = 22
        mini.BackgroundColor3 = Color3.fromRGB(70, 70, 70)
        
        -- resize frame menjadi ikon
        TweenService:Create(frame, TweenInfo.new(0.25), {
            Size = UDim2.new(0, 60, 0, 60),
            Position = UDim2.new(0.5, -30, 0.5, -30)
        }):Play()

        -- tengah-kan tombol mini
        TweenService:Create(mini, TweenInfo.new(0.25), {
        ...
        -- restore bentuk tombol mini
        mini.Text = "⤢"
        mini.TextSize = 16
        mini.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
        
        -- balikin ukuran frame
        TweenService:Create(frame, TweenInfo.new(0.25), {
            Size = originalSize,
            Position = originalPos
        }):Play()

        -- balikin tombol mini ke pojok
        TweenService:Create(mini, TweenInfo.new(0.25), {
            Position = UDim2.new(1, -30, 0, 5),
            Size     = UDim2.new(0, 28, 0, 28)
        }):Play()

        -- tampilkan kembali semua UI
